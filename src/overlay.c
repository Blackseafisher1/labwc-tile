		...
		struct wlr_box *box)
{
	...
	/*
	 * By default the overlay is drawn below the dragged view so it
	 * stays under other windows. With <snapping><overlay>
	 * <alwaysOnTop>yes</alwaysOnTop> it is placed in the preview tree
	 * above all windows instead.
	 */
	struct wlr_scene_tree *parent = rc.snap_overlay_always_on_top
	...
	if (rc.snap_overlay_always_on_top) {
